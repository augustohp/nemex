<?php
    ...
    $projectPath = NEMEX_PROJECTS.$newp;
    ...
    if (file_exists($projectPath)) {
        return error_log('Project already exists: '.$projectPath);
		    ...
		    mkdir(NEMEX_PROJECTS.$newp, 0777, true);
		 	$old = umask(0);
			chmod(NEMEX_PROJECTS.$newp, 0777);
			file_put_contents(NEMEX_PROJECTS.$newp.'/index.php', $redirect);
			umask($old);


		 	mkdir(NEMEX_PROJECTS.$newp.'/big', 0777, true);


		 	$old = umask(0);
			chmod(NEMEX_PROJECTS.$newp.'/big', 0777);
			file_put_contents(NEMEX_PROJECTS.$newp.'/big/index.php', $redirect);
			umask($old);
